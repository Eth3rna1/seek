...
```cmd
curl -L -o seek.exe https://github.com/Eth3rna1/seek/releases/download/v2.4.0/seek.exe
```

#### Using PowerShell
```cmd
Invoke-WebRequest -Uri "https://github.com/Eth3rna1/seek/releases/download/v2.4.0/seek.exe" -OutFile "seek.exe"
```

#### Manual Download
Alternatively, you can download the binary manually from the [Releases page](https://github.com/Eth3rna1/seek/releases/tag/v2.4.0)
